    ...
    {
        {
            Language.English, new()
            {
                ...
                { "loc_weapon_desc_shrapnelgun", "Fires ricocheting plasma shards that rebound off walls until their energy burns out. Handle with care." },
        ...
        },
        {
            Language.Spanish, new()
            {
                ...
                { "loc_weapon_desc_shrapnelgun", "Dispara fragmentos de plasma que rebotan en las paredes hasta que se agota su energía. Manéjela con cuidado." },
        ...
        },
        {
            Language.French, new()
            {
                ...
                { "loc_weapon_desc_shrapnelgun", "Tire des éclats de plasma ricochants qui rebondissent sur les murs jusqu'à épuisement de leur énergie. À manipuler avec précaution." },
        ...
        },
        {
            Language.German, new()
            {
                ...
                { "loc_weapon_desc_shrapnelgun", "Verschießt abprallende Plasmasplitter, die von Wänden zurückprallen, bis ihre Energie verbraucht ist. Vorsicht beim Umgang." },
